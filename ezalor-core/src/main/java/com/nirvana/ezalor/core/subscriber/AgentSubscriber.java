...
import com.nirvana.ezalor.core.broker.MessageBroker;
import com.nirvana.ezalor.core.broker.MessageBrokerContext;
...
public abstract class AgentSubscriber extends AbstractSubscriber implements AcknowledgeSubscriber {
     ...
     *
     * @see com.nirvana.ezalor.core.agent.Agent#sendPackage(Package)
     */
