package com.nirvana.ezalor.protocol.decoder;

import com.nirvana.ezalor.protocol.ProtocolPackage;
import com.nirvana.ezalor.protocol.ScalableNumberPart;
import com.nirvana.ezalor.protocol.HeaderPart;
import com.nirvana.ezalor.protocol.PayloadPart;
...
public class PackageFrameDecoder extends ByteToMessageDecoder {
    ...
    /*单帧最大长度*/
    private int maxFrameSize = ProtocolPackage.MAX_SIZE;
    ...
    public PackageFrameDecoder(int maxFrameSize) {
        this.maxFrameSize = maxFrameSize > ProtocolPackage.MAX_SIZE ? ProtocolPackage.MAX_SIZE : maxFrameSize;
    }
    ...
    private ProtocolPackage buildPackage() {
        return new ProtocolPackage(header, lengthRemain, identifier, payload);
    }
